...
BORDER = pygame.Rect(350, 0, 200, HEIGHT)
...
def draw_window(red, yellow, red_bullets, yellow_bullets):
    pygame.draw.rect(WIN, TRANSPARENT, BORDER)
...
def main():
    red = pygame.Rect(700, 210, SPACESHIP_WIDTH, SPACESHIP_HEIGHT)
    yellow = pygame.Rect(200, 210, SPACESHIP_WIDTH, SPACESHIP_HEIGHT) 
